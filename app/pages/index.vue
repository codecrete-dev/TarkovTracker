    ...
    <div class="mb-6">
      ...
      <div class="grid grid-cols-2 gap-3 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6">
        <div
          ...
          role="button"
          tabindex="0"
          class="hover:border-accent-500/30 focus-visible:border-accent-500 focus-visible:ring-accent-500/50 dark:border-accent-700/30 dark:bg-surface-800 dark:hover:border-accent-700/50 cursor-pointer rounded-lg border border-gray-200 bg-white p-3 shadow-sm transition-all outline-none hover:shadow-md focus-visible:ring-2"
