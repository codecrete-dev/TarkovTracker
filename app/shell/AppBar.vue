    ...
    <div class="flex h-full items-center gap-1 px-2 sm:gap-3 sm:px-3">
      ...
      <div class="ml-auto flex items-center gap-1 sm:gap-2">
        ...
        <USelectMenu
          ...
          :ui-menu="{
            ...
            option: {
              ...
              inactive:
                'text-content-secondary hover:bg-surface-200 dark:hover:bg-surface-800 hover:text-content-primary dark:text-surface-200 dark:hover:text-white',
        ...
        <span v-tooltip="nextThemeLabel" class="inline-flex">
          <button
            type="button"
            class="bg-surface-elevated border-base hover:bg-surface-100 dark:bg-surface-900/90 dark:hover:bg-surface-800 flex items-center justify-center rounded-md border px-2 py-1.5 ring-1 ring-gray-200/50 transition-colors dark:border-white/15 dark:ring-white/10"
        ...
        <template v-if="isLoggedIn">
          <UDropdownMenu :items="accountItems" :content="{ side: 'bottom', align: 'end' }">
            <button
              type="button"
              class="bg-surface-elevated border-base hover:bg-surface-100 dark:bg-surface-900/90 dark:hover:bg-surface-800 flex items-center justify-center rounded-md border p-1 ring-1 ring-gray-200/50 transition-colors dark:border-white/15 dark:ring-white/10"
            >
