<template>
  <div
    ...
    :class="[
      expandable
        ? 'cursor-pointer rounded-md border border-gray-300 p-2 transition-colors hover:bg-gray-100/50 dark:border-white/20 dark:hover:bg-white/5'
        : 'py-0.5',
    ...
    <div class="flex min-w-0 items-center overflow-hidden whitespace-nowrap">
      ...
      <div class="flex flex-1 flex-nowrap items-center gap-1.5 overflow-hidden">
        <router-link
          ...
          class="inline-flex shrink-0 items-center rounded px-2 py-0.5 text-xs no-underline transition-colors hover:opacity-90"
