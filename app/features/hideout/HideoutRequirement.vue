<template>
  ...
  <div
    class="group hover:bg-surface-elevated/50 relative flex h-full cursor-pointer flex-col items-center justify-center rounded-lg border p-2 transition-all select-none"
    :class="[
      isComplete
